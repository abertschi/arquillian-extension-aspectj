...
{
    public static final String MAVEN_USER_SETTINGS = "org.apache.maven.user.settings";
    public static final String MAVEN_USER_GLOBAL_SETTINGS = "org.apache.maven.global-settings";
    public static final String MAVEN_OFFLINE = "org.apache.maven.offline";
    public static final String LOCAL_REPO = "maven.repo.local";
